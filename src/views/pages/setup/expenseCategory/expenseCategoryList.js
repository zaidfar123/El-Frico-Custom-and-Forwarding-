...
export default function ExpenseCategoryList() {
    ...
    const handleStatus = (row) => {
        ...
        AxiosServices.deActivatedExpenseCategory([model]).then((res) => {
    ...
    const getList = () => {
        ...
        AxiosServices.getExpenseCategoryList(model).then((res) => {
    ...
    const columnConfig = [
        { name: 'Expense Category Name', col: 'expenseCategoryName' },
    ...
    return (
        <Grid container spacing={2}>
            ...
            {open && <ExpenseCategoryDialog open={open} handleClose={handleClose} item={item} getList={getList} />}
        </Grid>
    );
}
