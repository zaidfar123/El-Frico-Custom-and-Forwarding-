...
import ReimbursementCategoryForm from "./ReimbursementCategoryForm"
...
export default function ReimbursementCategory() {
    ...
    return (
        <React.Fragment>
            <MainCard title="Reimbursement Category Amount Configuration">
                ...
                <ReimbursementCategoryForm clearingID={fileNoState.clearingID === 0 ? null : fileNoState.clearingID} />
            </MainCard>
