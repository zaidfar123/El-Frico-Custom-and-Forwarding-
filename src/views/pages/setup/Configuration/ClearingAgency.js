...
import ClearingAgencyForm from "./ClearingAgencyForm"
...
export default function ClearingAgency() {
    ...
    return (
        <React.Fragment>
            <MainCard title="Agency Configuration">
                ...
                <ClearingAgencyForm clearingID={fileNoState.clearingID === 0 ? null : fileNoState.clearingID} ntn={state.ntn} customer={state.customer}/>
            </MainCard>
