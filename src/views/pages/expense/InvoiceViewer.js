                                    ...
                                    <Grid item xs={12}>
                                        <Grid container spacing={0}>
                                            ...
                                            <Grid item xs={4}>
                                                ...
                                                <Typography variant="body2">{item.employeeAssignedAmountTotalModels[RowIndex].employeeName}</Typography>
                                            </Grid>
                                            <Grid item xs={4}>
                                                <Typography variant="subtitle1">File No</Typography>
                                                <Typography variant="body2">{item.fileNo}</Typography>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TableContainer>
                                            ...
                                            >
                                                <TableHead sx={{ backgroundColor: theme.palette.mode === 'dark' ? theme.palette.primary.dark : theme.palette.secondary.light }}>
                                                    <TableRow>
                                                        <TableCell sx={{ pl: 1 }} align="left">Assigned Amount</TableCell>
                                                        <TableCell align="right">Assigned Date</TableCell>
                                                    </TableRow>
                                                </TableHead>
                                                <TableBody>
                                                    {item.employeeAssignedAmountTotalModels[RowIndex].employeeAssignedAmountModels.map((row, index) => (
                                                        <TableRow key={index}>
