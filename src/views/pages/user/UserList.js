...
export default function UserList() {
    ...
    const getList = () => {
        ...
        AxiosServices.getAllUserList(model).then((res) => {
    ...
    const columnConfig = [
        { name: 'User Name', col: 'userDetailName', caption: false },
        { name: 'Email', col: 'email', caption: true, model: "optionalEmailModels", object: "optionalEmail" },
        { name: 'Phone', col: 'mobileNo', caption: true, model: "optionalMobileModels", object: "optionalMobileNo" },
        { name: 'Roll Name', col: 'roleName', caption: false },
            ...
            <TableRow hover key={rowIndex}>
                ...
                {columnConfig.map((column, colIndex) => (
                    <TableCell key={colIndex} align="left">
                        {column.col === "isActive" ?
                            <Chip size="small" variant="outlined" style={{ color: row[column.col] ? "green" : "red", borderColor: row[column.col] ? "green" : "red" }} label={row[column.col] === true ? "Active" : "Inactive"} />
                            :
                ...
                <TableCell sx={{ pr: 3 }} align="center">
                    ...
                    <Tooltip title={row.isActive ? "Disable User" : "Activate User"}>
