...
import { Grid, TableCell, TableRow, IconButton, Tooltip, Checkbox, Typography, Badge, TextField, MenuItem, Button } from '@mui/material';
...
export default function FieldTeamList() {
    ...
    const columnConfig = [
        { name: 'File No', col: 'fileNo', download: false, width: 100, hasImageIcon: false },
        { name: 'Customer', col: 'customerName', download: false, width: 220, hasImageIcon: false },
        { name: 'Bill of Lading', col: 'billOfLading', download: false, width: 140, hasImageIcon: false },
        { name: 'Vessel', col: 'vessel', download: false, width: 120, hasImageIcon: false },
        { name: 'PDF', col: 'uploadedDoc', download: true, width: 60, hasImageIcon: false, },
        { name: 'Uploaded File', col: 'uploadedDoc', download: false, width: 140, hasImageIcon: true, },
        { name: 'Expense File', col: 'userExpenseModels', download: false, width: 130, hasImageIcon: true, },
        { name: 'Cargo File', col: 'cargoUserDetails', download: false, width: 130, hasImageIcon: true, },
